...
namespace lähi18._4
{
    class Program
    {
        static void Main(string[] args)  // Funktio / Metodi
        {
            ...
            // Funktio ja metdi ovat melkein samoja, erona on niiden sijainti.
            ...
            // muiden metodien / funktioiden kanssa, luokan sisälle
            //
            ...
            // olio on instanssi luokasta. Googlaa vaikka jokin kiva esimerkki.
            // Luokka on niinku se "Auto", geneerinen auton idea. Ja olio on ilmentymä, instanssi. Volvo, Audi, Lada.
            //Oletuksena metodeja voi ainoastaan käyttää, kun luokasta on luotu objekti.
            //Nyt uutta "printText()" -metodia ei voia käyttää, ellei luoda luokasta "Program" uutta objektia.
            ...
            //Nyt metodin "multiplyNumbers()" palautettava arvo toimii parametrinä
            //metodille "WriteLine()".
